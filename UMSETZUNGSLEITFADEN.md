...
| 18.08.2026 | 2,00 | „App-Fehlerbehebung via Coauthoring: zwei neue Anzeigefehler identifiziert und behoben (leere ComboBox-Beschriftungen bei Personen-/Auswahlfeldern, dauerhaft sichtbarer Hinweistext beim Vertragsvolumen-Pflichtfeld), IT-Security-Fehlerbehandlung ergänzt, Live-Test in Studio und veröffentlichter Version begleitet, Zugriffsproblem bei ComboBox-Datenquellen in der Play-Version eingegrenzt, Änderungshistorie seit Version 477 dokumentiert" | P6-Bestätigung, F21/F22-Fixes, ITSec-Notify, Doku AENDERUNGEN-SEIT-V477.md |
